...
import { emptyCell, monthLabels, stickyColumnStyles } from '@/components/finance-plan/config'
import { FinanceMonthCell, FinancePlanRow } from '@/components/finance-plan/types'
